                    ...
                    children: [
                      SizedBox(
                        ...
                        child: singleTextWeight(
                            "${member.name}", Colors.black, 16.dp),
                      ),
                      SizedBox(
                        width: Get.width * 0.3,
                        child: singleTextWeight(
                      ...
                      SizedBox(
                        width: Get.width * 0.2,
                        child: singleTextWeight(
                            "${member.count}", Colors.black, 16.dp,
          ...
          secondaryActions: <Widget>[
            ...
            GestureDetector(
              ...
              child: Container(
                  ...
                  child: Center(
                    child:
                        singleTextWeight(Translation.add, Colors.black, 16.dp),
                  )),
            ),
            GestureDetector(
              onTap: () async {
                controller.slidableController.activeState = null;
                _addOrReduceMemberCount(Get.context,
                    member: member, add: false);
              },
              child: Container(
                  height: double.infinity,
                  decoration: const BoxDecoration(
                  ...
                  child: Center(
                    child: singleTextWeight(
                        Translation.exchange, Colors.black, 16.dp),
                  )),
            ),
            GestureDetector(
              onTap: () async {
              ...
              child: Container(
                  ...
                  child: Center(
                    child: singleTextWeight(
                        Translation.delete, Colors.black, 16.dp),
                  )),
            ),
          ],
        ),
          ...
          children: <Widget>[
            ...
            Column(
              ...
              children: [
                ...
                singleTextWeight(Translation.addMember, c_00, 18.dp,
                  ...
                  child: Row(
                    ...
                    children: [
                      GestureDetector(
                          ...
                          child: singleTextWeight(
                              Translation.cancel, c_757676, 18.dp,
                      ...
                      GestureDetector(
                          onTap: () {
                            if (controller.temAddMember.checkComplete()) {
                              ...
                              Get.snackbar('提示',
                                  '填写不全,已填写信息:${controller.temAddMember.toJson()}');
                            }
                          },
                          child: singleTextWeight(
                              Translation.confirm, c_5ADBEA, 18.dp,
                              fontWeight: FontWeight.normal)),
                    ],
                  ),
                )
        ...
        return SimpleDialog(
          ...
          children: <Widget>[
            ...
            Column(
              ...
              children: [
                Get.getHeightBox(20.dp),
                singleTextWeight(Translation.changePoints, c_00, 18.dp,
                    fontWeight: FontWeight.bold),
                Get.getHeightBox(10.dp),
                SizedBox(
                  width: MediaQuery.of(context).size.width * 0.6,
                ...
                SizedBox(
                  ...
                  child: Row(
                    ...
                    children: [
                      GestureDetector(
                          onTap: () => Navigator.of(context).pop(),
                          child: singleTextWeight("取消", c_757676, 18.dp,
                              fontWeight: FontWeight.normal)),
                      Container(
                        height: 60.dp,
                        color: c_FF,
                      ...
                      GestureDetector(
                          onTap: () {
                            ...
                            controller.updateMember(
                                member, add ? changeValue : (-changeValue),
                                note: note);
                            Navigator.of(context).pop();
                          },
                          child: singleTextWeight("确定", c_5ADBEA, 18.dp,
                              fontWeight: FontWeight.normal)),
                    ],
                  ),
                )
        ...
        return SimpleDialog(
          ...
          children: <Widget>[
            ...
            Column(
              ...
              children: [
                Get.getHeightBox(20.dp),
                singleTextWeight("删除", c_00, 18.dp,
                    fontWeight: FontWeight.bold),
                Get.getHeightBox(10.dp),
                ...
                SizedBox(
                  ...
                  child: Row(
                    ...
                    children: [
                      GestureDetector(
                          onTap: () => Navigator.of(context).pop(),
                          child: singleTextWeight("取消", c_5ADBEA, 18.dp,
                              fontWeight: FontWeight.normal)),
                      Container(
                        height: 60.dp,
                        color: c_FF,
                      ...
                      GestureDetector(
                          ...
                          child: singleTextWeight("删除", c_757676, 18.dp,
                              fontWeight: FontWeight.normal)),
                    ],
                  ),
                )
